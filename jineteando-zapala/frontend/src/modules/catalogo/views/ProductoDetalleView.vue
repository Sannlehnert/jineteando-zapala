        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <div class="rounded-card overflow-hidden bg-secundario/20 aspect-[4/3] flex items-center justify-center">
              <img v-if="imagenSeleccionada" :src="imagenSeleccionada" :alt="producto.nombre" class="w-full h-full object-contain" />
          ...
          <div class="flex flex-col justify-center">
            ...
            <p class="text-3xl font-serif text-primario">${{ producto.precio_minorista.toLocaleString() }}</p>
            ...
            <a
              ...
              target="_blank"
              class="mt-8 inline-flex items-center gap-2 bg-whatsapp text-white px-8 py-3.5 rounded-full text-sm font-medium hover:scale-105 transition-transform shadow-md self-start"
            >
