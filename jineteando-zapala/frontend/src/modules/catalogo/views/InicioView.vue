...
<template>
  <div class="min-h-screen bg-[#FDFBF7] text-[#2C2A28]">
    ...
    <header class="py-16 px-5 text-center">
      <h1 class="text-4xl md:text-5xl font-serif font-bold mb-4">Jineteando Zapala</h1>
      <p class="text-lg text-gray-600 max-w-2xl mx-auto">Productos regionales y de campo. Calidad, tradición y autenticidad desde Zapala, Neuquén.</p>
    </header>
    ...
    <section class="bg-white border-t border-gray-200 py-12">
      <div class="max-w-4xl mx-auto px-5 text-center">
        ...
        <p class="text-gray-600">Bernardo Houssay 686, Zapala, Neuquén</p>
        <p class="text-gray-600 mt-1">Lunes a sábado: 09:00–13:00 y 16:30–20:30</p>
        <a
          :href="generarUrlWhatsApp('Hola, quisiera información sobre sus productos.')"
          target="_blank"
        ...
        <div class="mt-8 flex justify-center gap-4 text-sm text-gray-500">
          <a href="https://instagram.com/Jineteandozapala" target="_blank" class="hover:text-amber-800">Instagram</a>
          <a href="https://facebook.com/Jineteandozapala" target="_blank" class="hover:text-amber-800">Facebook</a>
          <a href="https://tiktok.com/@Jineteandozapala" target="_blank" class="hover:text-amber-800">TikTok</a>
        </div>
      </div>
    </section>
  </div>
